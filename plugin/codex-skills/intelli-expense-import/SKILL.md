...
Read `../../README.md`, `../../schema/sidecar.schema.json`, and `../../schema/manifest.schema.json` before writing drops. Use `../../fixtures/` for shape checks.
...
6. Present every field for every receipt to the user and wait for explicit approval before writing any sidecar.
   In Codex, ask in chat and wait for the user's reply; do not auto-resolve this confirmation.
